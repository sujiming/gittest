...
<html>
	...
	<div class="container" style=" margin: 10px auto;width: 980px;height: 400px;">
		<div class="status" style="border:1px solid #414141; width: 100%;margin-bottom: 40px" >
			<div class="statusup" style="background-color:#E7E7E7; width: 100%;height: 60px;color: #000">
				...
				<div style="margin-top:10px;margin-left:20px; float: left;font-size: 18px;">订单提交成功</div>
				<div style="clear: ;"></div>
			</div>
			<div class="statusdown" style="margin-top:10px;margin-left:90px; ">>>订单号：<%=request.getParameter("ordersid") %></div>
			<div class="statusdown" style="margin-top:10px;margin-left:90px; ">>>收货人姓名：<%=request.getParameter("name") %></div>
			<div class="statusdown" style="margin-top:10px;margin-left:90px; ">>>收货人手机号：<%=request.getParameter("mobile") %></div>
			<div class="statusdown" style="margin-top:10px;margin-left:90px; ">>>收货地址：<%=request.getParameter("address") %></div>
			<div class="statusdown" style="margin-top:10px;margin-left:90px; ">>>总金额：<%=request.getParameter("total") %></div>
			<div style="margin: 10px auto; width: 850px;background-color: #E7E7E7;height: 1px;"></div>
			<div  style="margin-top:10px;margin-left:90px; ">支付方式：</div>
			<div  style="margin-top:10px;margin-left:90px;margin-bottom: 30px ">
				<input type="radio" name="type" value="银行卡支付" onclick="yinhangka()">银行卡支付
				<input type="radio" name="type" value="第三方支付" onclick="disanfang()"> 第三方支付
			</div>
			<div class="yinhangka" style="display: none;width: 643px;height: 358px;margin-left:90px;margin-bottom: 50px"><img src="/Flowers/static/images/yinhangka.jpg" /></div>
			<div class="disanfang" style="display: none;border: 1px double #E7E7E7; width: 900px;height: 90px;margin-left:50px;margin-bottom: 50px"><img src="/Flowers/static/images/disanfang.png" />
				<a href="/Flowers/order/yeepay.jhtml?ordersid="+<%=request.getParameter("ordersid") %>><img src="/Flowers/static/images/ee1.jpg" style="height: 30px;width: 120px;margin-left: 100px; margin-bottom: 23px;"/></a>
			</div>
			...
			<img src="/Flowers/static/images/xiaoyue.png" style="margin-top:20px;margin-left:10px; float: left;">
		</div>
	</div>
	<div class="footer">
	<div class="four_nav">
