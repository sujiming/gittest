...
<head>
<meta charset="UTF-8">
<title>figure 后台登录界面</title>

<link rel="stylesheet" href="/Flowers/static/css/normalize.css">
...
<script src="/Flowers/static/jquery-easyui-1/jquery.min.js"></script>
</head>

<body>
	<div class="login">
		<h1>figure登录</h1>
		<form method="post" action="/Flowers/AdminLoginServlet">
			<input type="text" id="name" name="name" placeholder="用户名"
				...
				<%
							String str=(String)request.getAttribute("AdminLogin");
							if(str==null){
								str="";
							}
				%>
