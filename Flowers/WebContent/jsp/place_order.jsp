			...
			<div class="order-left">
				...
				<div id="address_mylist_1"  >
					...
					<div class="order-per" id="address_mylist">
						...
						<span id="span_mylove" style="display: block;"></span>
						<table  border="0" cellspacing="0" cellpadding="0" class="mb10">
							...
							<tr id="address_add_0">
								<input type="submit" style="background-color: white;"  onclick="djjdz()" value="点击添加新地址" />
							</tr>
						</table>
					</div>
				</div>
				...
				<div id="consignee_addr" class="hide" style="display:none;">
					<table width="100%" height="150" border="0" cellspacing="0">
						<tr height="55">
							...
							<td width="220" align="left" class="cor-2">
								<input id="contactname" name="contactname"  class="contactname_input" type="text"  maxlength="11" />
							</td>
							<td width="150"></td>
							<td></td>
						</tr>
						...
						<tr>
							<td align="left" ><span class="red">*</span>详细地址：</td>
							<td align="left" colspan="3" class="cor-2">
					...
					<tr>
						...
						<td>
						&nbsp;<input type="image" src="/Flowers/static/images/butto.gif" id="button_img" onclick="checkInfo()" />
						</td>
						<td></td>
					</tr>
						...
						<table border="0" cellspacing="0" id="shop_address_show" cellpadding="0">
							...
							<tr id="address_shop_mymobile">
								...
								<span class="pl6">提货人手机<i></i>&nbsp;
										...
										titles="收礼人手机" name="un" value="" title="用于查看祝福语">
								</span> 
				...
				<!-- 商品清单 -->
				 <div class="order-other">
					 ...
					 <% 
						...
						List list=(List)request.getAttribute("prod");
						double tt=0;
						if(list!=null){
						...
						<td colspan="4">	
							<div class="commodity-list">
								...
								<div style="width:405px; float:left">
									<a href="">
										<img style="width:150px;heith:180px" src="/Flowers/static/productImg/<%=product.getProductPicture() %>" alt="rose";"/></a>
								...
								<div class="commodity-list-left">
										<div class="w100 fl">
											...
											<span class="list-color2"><%=product.getProductName()%></span>
										</div>
										<div class="w100 fl">
										...
										<span id="city_span_show_12" class="iscity_show" onmouseover="$('#city_help_12').show();" onmouseout="$('#city_help_12').hide();">
											<input type="checkbox" style="border-radius: 3px;"/>
									...
									<% 
									tt=tt+Double.valueOf(product.getProductNum())*Double.valueOf(product.getProductPrice());
							...
							<div style="width:405px; float:left">
								...
								<tr>
									 ...
									 <div class="leave_w2">
									    ...
									    <hr style="backGround-color: black;width: 120%;" />
									    <div class="leave_con">
					...
					<table width="960px" height="auto" border="0" cellspacing="0" cellpadding="0" >
						...
						<tr id="gift_list" class="pay_total">
							<td align="right">
								<span style="display: none" id="my_total"><%=tt %></span>
								<span>总计：</span>
					...
					<div class="sub-tt" id="pay_submit_div">
						<input id="pay_submit_btn" width="200" type="image" onclick="submitdan()" height="37" src="/Flowers/static/images/da_01.jpg" />
					</div>				
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function submitdan(){
		var name=$("#contactname").val()
	        	var address=$("#privince").val()+$("#city").val()+$("#area").val()+$("#address").val();
		$.ajax({
	        type:"post",				//后面用","很容易出错
	        url:"/Flowers/OrderUpdate",
	        data:{leaveWord:$("#bless_12").val(),ordersID:<%=request.getParameter("ordersid")%>,consigneeName:name,consigneeAddress:address,consigneePhone:$("#mobile").val()},
	        success:(function(result){
	        	if(result.code=='200'){
	               	window.location.href="/Flowers/jsp/success.jsp?ordersid="+<%=request.getParameter("ordersid")%>+"&name="+name+"&mobile="+$("#mobile").val()+"&address="+address+"&total="+$("#totalPrices").val()
	        	}
...
<script type="text/javascript">
			...
			function checkInfo(){
				$("#span_mylove").show();
				$("#consignee_addr").hide();
				var info="姓名："+$("#contactname").val()+"   "+"手机号："+$("#mobile").val()+"    地址："+$("#privince").val()+$("#city").val()+$("#area").val()+$("#address").val()
				$("#span_mylove").text(info)
			}
	</script>
</body>
